(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.GIT = {}));
    ...
    */
    ...
    var CesiumHandler = (function(){
        ...
        async function init(elementId, { tilesetUrl, propertyUrls } = {}) {
            ...
            if (tilesetUrl) {
                await renderingAllTileset({ url: tilesetUrl });
    ...
    async function CesiumViewer(target, options = {}) {
      ...
      const { viewer, Mode } = await CesiumHandler.init(elementId, options);
      return {
        viewer,
        Mode,
        setMode: CesiumHandler.setMode,
      };
    }
...
//# sourceMappingURL=cesium-viewer.umd.js.map
